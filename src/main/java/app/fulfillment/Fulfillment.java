...
public class Fulfillment {
    ...
    public static Event verifyAndReturn(String payload, String header)
    ...
    public static Integer fulfill(Event event) throws StripeException {
        ...
        switch (event.getType()) {
            ...
            case "payment_intent.payment_failed":
                ...
                System.out.println("Webhook received! Payment for PaymentIntent " + pi.getId() + " failed");
                break;
            ...
            case "source.chargeable":
                ...
                /*
                 * System.out.println("Webhook received! The source " + source.getId() +
                 * " is chargeable");
                 */
                 ...
                 * 
                 * // If there was no PaymentIntent associated with the source, return a 400 if
                 * (paymentIntentId == null) { System.out.
                 * println("Could not find a PaymentIntent in the source.chargeable event " +
                 * event.getId()); return 400; }
                 * 
                 * // Get the PaymentIntent pi =
                 * PaymentIntent.retrieve(source.getMetadata().get("paymentIntent"));
                 * 
                 * // If the PaymentIntent already has a source, return a 403 if
                 * (!(pi.getStatus().equals("requires_payment_method"))) { return 403; }*
                 * 
                 * // Confirm the PaymentIntent using the source id Map<String, Object> params =
                 * new HashMap<String, Object>(); params.put("source", source.getId());
                 * pi.confirm(params);
                 */
            ...
            case "source.failed":
                ...
                // Print a failure message
                /*
                 * System.out.println("The Source " + source.getId() + " failed or timed out.");
                 */
